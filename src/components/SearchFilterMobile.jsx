				...
				<div className='relative'>
						...
						<div className='mt-8 flex justify-center text-lg w-full'>
							...
							>
								<div className='flex flex-col gap-3'>
									<label htmlFor='area' className='heading'>
										Area/Project
									</label>
									<input
										type='text'
								...
								<div>
									<label htmlFor='type' className='heading '>
										Project Type
									</label>
								...
								<div className='flex flex-col gap-2 dev'>
					...
					<div className='p-4 sticky box-top-shadow border border-t-slate-100  bottom-0 bg-white py-2'>
						<div className='flex justify-between'>
							...
							<input
								type='submit'
								className='p-2 border-none text-center outline-none bg-black text-white'
								value='Show Results'
							/>
						</div>
					</div>
