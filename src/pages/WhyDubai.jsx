      ...
      <main className='lg:pt-16'>
        ...
        <div className='container mx-auto md:max-w-[700px]'>
          <div className='px-4 md:px-0 mt-6'>
            <h1 className='heading md:hidden'>Why Dubai</h1>
            <p>
             ...
             {!extend &&  <span className='text-sm cursor-pointer text-slate-400' onClick={() => setExtend(true)}>{  '...Read More'}</span>}
            </p>
            ...
            <p>
              ...
              cupiditate atque sequi doloremque.Lorem ipsum dolor sit amet,
              consectetur adipisicing elit.
                  <span className='text-sm ml-2 cursor-pointer text-slate-400' onClick={() => setExtend(false)}>{  'Read Less'}</span>
                  </p>
                </>
              )
          }
